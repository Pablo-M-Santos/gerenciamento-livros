...
public class AuthenticationController {
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Request successful.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = LoginResponseDTO.class), examples = @ExampleObject(value = "{\"token\": \"token\", \"name\": \"username\", \"email\": \"email@gmail.com\", \"role\": \"USER_ROLE\"}"))),
                        @ApiResponse(responseCode = "500", description = "There was an internal error.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorResponse.class), examples = @ExampleObject(value = "{\"status\": 0, \"timestamp\": \"2000-01-01T00:00:00Z\", \"type\": \"https://localhost/invalid-data\", \"title\": \"Invalid data\", \"detail\": \"One or more fields are invalid. Fill in correctly and try again.\", \"userMessage\": \"One or more fields are invalid. Fill in correctly and try again.\", \"objects\": \"List of objects or fields that generated or error (optional)\"}")))
        })
