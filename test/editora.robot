...
${EMAIL_PUBLISHER}      editoraRobot1@gmail.com
...
Teste Sobre Editora
    ...
    Wait Until Element Is Visible    css=[itemid="visibility-Editora Robot Atualizacao"]    
    Click Element    css=[itemid="visibility-Editora Robot Atualizacao"]
