    ...
    >
      ...
      <template #body-cell-actions="props">
        <q-td :props="props" class="actions-cell">
          ...
          >
            <q-tooltip>Editar locatario</q-tooltip>
          </q-btn>

          <q-btn
            v-if="isAdmin && !isRenterWithRentals(props.row.id)"
            flat
            round
            dense
            icon="delete"
          ...
          >
            <q-tooltip>Excluir locatario</q-tooltip>
          </q-btn>
        </q-td>
      </template>

      <template #no-data>
        <div class="q-pa-lg text-grey-7">Nenhum locatario encontrado.</div>
      </template>
    </q-table>
  </q-card>
</template>
...
const isRenterWithRentals = (renterId) =>
  props.rentersWithRentals.includes(renterId);
</script>
