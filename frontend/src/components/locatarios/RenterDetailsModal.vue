    ...
    <q-card class="modal-card modal-animated">
      ...
      <q-card-section class="modal-header-section">
        <div class="modal-title">
          ...
          <span>Detalhes do Locatario</span>
        </div>
        <p class="modal-subtitle">Informacoes completas do locatario</p>
      </q-card-section>
      ...
      <q-card-section class="modal-content">
        ...
        <q-input
          ...
          rounded
          readonly
          :model-value="renterData.telephone"
          label="Telefone"
          class="form-input"
        />
        <q-input
          ...
          rounded
          readonly
          :model-value="renterData.address"
          label="Endereco"
          class="form-input"
        />
        <q-input
