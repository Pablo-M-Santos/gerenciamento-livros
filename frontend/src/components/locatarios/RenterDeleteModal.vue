  ...
  >
    <q-card class="confirm-card modal-animated">
      ...
      <q-card-section class="modal-header-section">
        ...
        <p class="modal-subtitle">Esta acao nao pode ser desfeita</p>
      </q-card-section>
      ...
      <q-card-section class="modal-content">
        <div class="delete-warning">
          ...
          <p class="delete-note">
            O locatario sera removido permanentemente do sistema.
          </p>
        </div>
      </q-card-section>
      ...
      <q-card-actions align="right" class="modal-actions-bottom">
        ...
        <q-btn
          ...
          no-caps
          color="negative"
          label="Excluir Locatario"
          itemid="BtnExcluirLocatario"
          @click="$emit('confirm')"
          class="btn-danger"
        />
      </q-card-actions>
